  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-4">
        <Image alt="klarna" src="/klarna.png" width={50} height={25} className="rounded-md"/>
        <Image alt="klarna" src="/cards.png" width={50} height={25} className="rounded-md"/>
        <Image alt="klarna" src="/stripe.png" width={50} height={25} className="rounded-md"/>
      </div>

        {/* action button */}
      <button
        type="submit"
        className="w-full bg-gray-800 text-white p-2 rounded-lg cursor-pointer flex items-center justify-center hover:bg-gray-900 transition-all duration-300"
      >
